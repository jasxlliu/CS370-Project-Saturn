...
Basic course of events: 1. User provides a list of audio files to be edited and an audio clip to insert.
...
Alternate Paths:        1. The user is unhappy with their remixed audio and would like their original sound files back.
...
Basic Course of Events: 1. User adds/looks at the current directory of sounds
...
Alternate Paths:        1. The user no longer wants to see their sounds sorted in alphabetical order and would like to unsort them (?)
